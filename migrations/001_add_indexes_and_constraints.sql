...
-- Check constraints for request status with NOT VALID (avoids table locking during creation)
DO $$ 
BEGIN
    IF NOT EXISTS (
...
-- Check constraints for payments status if table exists with NOT VALID
DO $$ 
BEGIN
